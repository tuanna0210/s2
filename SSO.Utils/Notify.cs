...
namespace SSO.Utils
{
    public class Notify
    {
        public const string Notifys = "Thông báo! ";
        public const string AddSuccess = "Đã tạo mới dữ liệu thành công! ";
        public const string AddError = "Tạo mới dữ liệu không thành công! ";
        ...
        public const string DeleteErrorByUsing = "Xóa dữ liệu không thành công do đang được sử dụng! ";
        ...
        public const string RegisterSuccess = "Đăng ký tài khoản thành công! Kiếm tra hòm thư và kích hoạt tài khoản";
        public const string RecoverPasswordRequestSuccess = "Gửi yêu cầu thành công! Kiếm tra hòm thư để nhận link thay đổi mật khẩu";
        public const string RecoverPasswordSuccess = "Cập nhật mật khẩu thành công";
        public const string RegisterFail = "Đăng ký tài khoản không thành công! ";
        public const string ActivateFail = "Kích hoạt tài khoản không thành công! ";
        ...
        public const string ExistsErorr = "Có lỗi xảy ra trong quá trình cập nhật! ";
        public const string TimeOutErorr = "Đã hết giờ làm bài! ";
        public const string DataNotvalid = "Dữ liệu không hợp lệ ! ";
        public const string ExistRecord = "Dữ liệu đã tồn tại! ";
        public const string NoImage = "/Resources/img/userpic.png";
        public const string PageNotfound = "Trang không tồn tại";
    }
}
